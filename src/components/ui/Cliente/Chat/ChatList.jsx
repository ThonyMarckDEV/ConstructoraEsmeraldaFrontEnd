...
const ChatList = ({ chats, onSelectChat, selectedChatId, loading, userRole }) => {
  ...
  if (chats.length === 0) {
    return (
      <div className="flex items-center justify-center h-64 bg-gray-50 border rounded-lg m-4">
  ...
  return (
    <div className="overflow-y-auto h-full bg-gradient-to-b from-white to-blue-50">
      {chats.map(chat => {
        ...
        return (
          <div
            ...
            className={`cursor-pointer p-4 border-b border-gray-100 transition-all duration-300 hover:bg-white ${
              isSelected 
                ? 'bg-white border-l-4 border-blue-500 md:border-l-4' 
                : ''
            }`}
          >
            <div className="flex justify-between items-start">
              ...
              <div className="flex flex-col items-end space-y-1">
                ...
                {chat.mensajes_no_leidos > 0 && (
                  <span className="inline-flex items-center justify-center px-2.5 py-1.5 text-xs font-bold text-white bg-blue-600 rounded-full shadow-md">
