...
const ChatInput = ({ onSendMessage, isSending, socketConnected }) => {
  ...
  const handleSendMessage = (e) => {
    e.preventDefault();
    if (newMessage.trim() && !isSending && socketConnected) {
  ...
  return (
    <div className="bg-white border-t border-gray-200 p-2 sm:p-3 sticky bottom-0 left-0 right-0 z-10 shadow-md">
      <form 
      ...
      >
        ...
        <button 
          ...
          disabled={!socketConnected || !newMessage.trim() || isSending}
