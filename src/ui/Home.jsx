              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Los más altos estándares en cada proyecto</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Técnicas y materiales de vanguardia</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Expertos comprometidos con la excelencia</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="bg-green-100 p-2 rounded-md mr-3 flex-shrink-0">
                    <Compass className="text-green-700" size={18} />
                  </div>
                  <div>
            ...
            <div className="w-full md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm md:text-base text-gray-800">Visualización de avances con realidad aumentada</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="text-green-600 mr-3 flex-shrink-0" size={20} />
                  <span className="text-sm md:text-base text-gray-800">Chat en tiempo real con el encargado del proyecto</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="text-green-600 mr-3 flex-shrink-0" size={20} />
                  <span className="text-sm md:text-base text-gray-800">Documentación y planos accesibles digitalmente</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="text-green-600 mr-3 flex-shrink-0" size={20} />
                  <span className="text-sm md:text-base text-gray-800">Seguimiento detallado de cada fase del proyecto</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="text-green-600 mr-3 flex-shrink-0" size={20} />
                  <span className="text-sm md:text-base text-gray-800">Galería de imágenes actualizada semanalmente</span>
                </div>
              </div>
            </div>
